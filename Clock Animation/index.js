...
var cl = {
    ...
    load: function () {
        ...
        clock.style.transition = 'all is';
        clock.style.webkitTransition = 'all is';
        clock.style.msTransition = 'all is';
        clock.style.mozTransition = 'all is';
        clock.style.oTransition = 'all is';
        ...
        //Remove 'transition' on click frame
        setTimeout(function () {
